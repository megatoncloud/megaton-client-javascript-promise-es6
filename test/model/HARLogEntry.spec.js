...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MegatonApi.HARLogEntry();
  });
  ...
  describe('HARLogEntry', function() {
    it('should create an instance of HARLogEntry', function() {
      // uncomment below and update the code to test HARLogEntry
      //var instane = new MegatonApi.HARLogEntry();
      //expect(instance).to.be.a(MegatonApi.HARLogEntry);
    });
