...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MegatonApi.Tenant();
  });
  ...
  describe('Tenant', function() {
    it('should create an instance of Tenant', function() {
      ...
      //var instane = new MegatonApi.Tenant();
      //expect(instance).to.be.a(MegatonApi.Tenant);
    });
    ...
    it('should have the property loadAuthToken (base name: "loadAuthToken")', function() {
      // uncomment below and update the code to test the property loadAuthToken
      //var instane = new MegatonApi.Tenant();
      //expect(instance).to.be();
    });
