...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MegatonApi.HARPostData();
  });
  ...
  describe('HARPostData', function() {
    it('should create an instance of HARPostData', function() {
      // uncomment below and update the code to test HARPostData
      //var instane = new MegatonApi.HARPostData();
      //expect(instance).to.be.a(MegatonApi.HARPostData);
    });
